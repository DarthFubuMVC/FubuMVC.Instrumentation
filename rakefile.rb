...
RESULTS_DIR = "results"
PRODUCT = "FubuMVC.Diagnostics"
COPYRIGHT = 'Copyright 2012 FubuMVC.Diagnostics. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version] do
  bottles("assembly-pak src/FubuMVC.Instrumentation -p FubuMVC.Instrumentation.csproj")

  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/FubuMVC.Instrumentation.sln', :clrversion => CLR_TOOLS_VERSION
